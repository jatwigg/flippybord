 ...
 */
public class MainThreadStates extends Thread {
    ...
    private _2DGameActivityWithStates _gameActivity;
    ...
    public MainThreadStates(_2DGameActivityWithStates gameActivity) {
        super();
    ...
    @Override
    public void run() {
        Log.d(getClass().getSimpleName(), "Doing init");
 ...
 */
                    ...
                    //check for pendingStateChange
                    if (isPendingStateChange) {
                        _gameActivity.beginStateSwitch();
                        continue;
                    }
