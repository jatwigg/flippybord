...
//TODO: tidy up this and MainThreadStates, perhaps they can have a common ancestor.
//TODO: also when you set the framerate to something high, there is still an issue with the game speeding up and slowing down but elapsedSeconds() seems constant...
public class MainThread extends Thread {
    ...
    @Override
    public void run() {
        Log.d(MainThread.class.getSimpleName(), "Doing init");
        if (!this._gameActivity.isInitalized()) {
            this._gameActivity.doInit();
        }

        Canvas canvas;
        Log.d(MainThread.class.getSimpleName(), "Starting game loop");
        ...
        Log.d(MainThread.class.getSimpleName(), "Ended game loop.");
    }
